...
config_yaml=./examples/Robotwin/new_train/starvla_qwenpiv3_la_softvq.yaml
...
run_id=0616_hanging_mug_clean_action_randomized_latent_qwenpiv3_la_softvq
batch_size=8
...
accelerate launch \
  ...
  --framework.latent_action.action_train_robot_types null \
  ...
  --datasets.vla_data.latent_action.horizon 48 \
