...
config_yaml=./examples/Robotwin/new_train/starvla_qwenwmv3_hdf5_aloha_clean_random_la_sharla_foresight.yaml
...
run_id=0807_${data_mix}_action_${latent_data_mix}_latent_qwenwmv3_la_sharla_a2a_foresight
