...
config_yaml=./examples/Robotwin/new_train/starvla_qwenwmv32_la_mem_hdf5_aloha_clean_random_la_sharla_foresight_soft_kl.yaml
...
run_id=0919_${data_mix}_action_${latent_data_mix}_latent_qwenwmv32_la_mem_sharla_a2a
