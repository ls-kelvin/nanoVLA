...
###########################################################################################
# QwenPI_v4_LA + SoftVQ on RoboTwin2.0 raw HDF5 aloha-agilex EEF data.
...
config_yaml=./examples/Robotwin/new_train/starvla_qwenpiv4_hdf5_aloha_clean_random_la_softvq.yaml
run_root_dir=./results/Checkpoints2
data_mix=hdf5_aloha_clean_eef
latent_data_mix=hdf5_aloha_clean_random_eef
run_id=0629_${data_mix}_action_clean_random_latent_qwenpiv4_la_softvq_w_smooth
batch_size=16
...
accelerate launch \
  ...
  --framework.latent_action.softvq.ckpt_path '/inspire/qb-ilm/project/qproject-fundationmodel/public/jjc/exp/sharla/0629_joint_aloha_stride16_w_vision1w_cross_va1_num_query=8_w_smooth0.01/checkpoints/partial_step_150000.pt' \
  --framework.latent_action.softvq.config_path '/inspire/qb-ilm/project/qproject-fundationmodel/public/jjc/exp/sharla/0629_joint_aloha_stride16_w_vision1w_cross_va1_num_query=8_w_smooth0.01/config.yaml' \
