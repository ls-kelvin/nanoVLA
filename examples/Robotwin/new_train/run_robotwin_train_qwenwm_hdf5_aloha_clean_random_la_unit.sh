...
run_id=0708_${data_mix}_joint_action_latent_qwenwm_la_unit
batch_size=16
hdf5_root=/inspire/qb-ilm/project/qproject-fundationmodel/public/zzt/data/RoboTwin2.0/dataset
unit_tokenizer_ckpt=/inspire/qb-ilm/project/qproject-fundationmodel/public/zzt/starVLA/third_party/UniT/outputs/robotwin_hdf5_endpose_tokenizer
