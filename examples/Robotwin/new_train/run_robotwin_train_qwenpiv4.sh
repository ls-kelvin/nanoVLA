...
###########################################################################################
# QwenPI_v4 on RoboTwin.
# QwenMetaQuery-style action head, but uses the full QwenVL prompt sequence directly
# as action-model cross-attention context instead of appending metaquery tokens.
