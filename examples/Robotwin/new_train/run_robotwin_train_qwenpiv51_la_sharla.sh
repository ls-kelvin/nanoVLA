...
config_yaml=./examples/Robotwin/new_train/starvla_qwenpiv51_hdf5_aloha_clean_random_la_sharla.yaml
...
run_id=qwenpiv51_${data_mix}_action_${latent_data_mix}_latent_la_sharla_a2a_soft_kl
