...
###########################################################################################
# QwenMetaQuery_LA + vision-only SoftVQ KL latent-action loss on RoboTwin.
###########################################################################################
...
config_yaml=./examples/Robotwin/train_files/starvla_metaquery_la_softvq_robotwin.yaml
run_root_dir=./results/Checkpoints
data_mix=robotwin32_cross_place_phone_stand
run_id=0610_${data_mix}_qwen_metaquery_la_softvq
batch_size=16
