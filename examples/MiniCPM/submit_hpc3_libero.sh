...
#   - Per-device BS=16, num_processes=8, GRAD_ACCUM=1 -> effective BS = 128
#   - GRAD_ACCUM is passed explicitly so this script is not affected by the
#     base YAML's trainer.gradient_accumulation_steps value.
#
# Usage:
