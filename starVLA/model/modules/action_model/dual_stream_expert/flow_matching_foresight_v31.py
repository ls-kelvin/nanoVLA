...
"""QwenWMv31_LA two-pass foresight on top of ``DualStreamFlowMatchingWM``.
...
class DualStreamFlowMatchingForesightV31(DualStreamFlowMatchingWM):
    """``DualStreamFlowMatchingWM`` with two-pass state/latent KV foresight."""
    ...
    def __init__(self, global_config):
        ...
        if num_learnable_tokens is None:
            raise ValueError(
                "DualStreamFlowMatchingForesightV31 requires "
