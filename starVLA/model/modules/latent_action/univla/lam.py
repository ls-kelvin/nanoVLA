...
from starVLA.model.modules.latent_action.univla.blocks import (
...
class UncontrolledDINOLatentActionModel(nn.Module):
    ...
    def __init__(
        ...
        self.dino_encoder = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitb14_reg', skip_validation=True)
